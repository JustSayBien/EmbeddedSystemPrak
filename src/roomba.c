...
/*********************************************************** Local variables */
//flags to check if a song was already defined
...
int32_t roombaQuerySensor(packet query_packet) {
	...
	//update distance variables in roombadata
	...
	//update angle variable in roombadata
...
void roombaPlaySongTheme() {
	//define the song if necessary
	if (!defined_song_theme) {
