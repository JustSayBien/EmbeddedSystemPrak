/**
 * $Id: gprintf.c 468 2011-02-21 15:53:05Z klugeflo $
 */
...
int gputs(int32_t (*putchar_fn)(int32_t), const char *p) {
  return gprintf(putchar_fn, p);
}

int gprintf(int32_t (*putchar_fn)(int32_t), const char *format, ...) {
  va_list args;
