...
extern int32_t query_results[QUERY_LENGTH];
...
/**
  ...
  *
  */
void query_list(const packet * packets[], int count, int32_t results[]);
...
/**
  ...
  *
  */
void write_query_list(const packet * packets[], int count);
...
/**
  ...
  *
  */
void read_query_list(const packet * packets[], int count, int32_t results[]);
